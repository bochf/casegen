...
pkgdatadir = $(datadir)/ssvctest
pkgincludedir = $(includedir)/ssvctest
pkglibdir = $(libdir)/ssvctest
pkglibexecdir = $(libexecdir)/ssvctest
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = casegen$(EXEEXT) test_graph$(EXEEXT) \
	test_bitmap$(EXEEXT)
subdir = .
...
am_casegen_OBJECTS = casegen.$(OBJEXT) graph.$(OBJEXT) \
	traveller.$(OBJEXT) state_machine.$(OBJEXT)
casegen_OBJECTS = $(am_casegen_OBJECTS)
casegen_DEPENDENCIES = $(SECURITY_DIR)/libs/linux/Release/safec.a
am_test_bitmap_OBJECTS = test_bitmap.$(OBJEXT)
test_bitmap_OBJECTS = $(am_test_bitmap_OBJECTS)
test_bitmap_DEPENDENCIES =
am_test_graph_OBJECTS = test_graph.$(OBJEXT) graph.$(OBJEXT) \
	traveller.$(OBJEXT)
...
CXXLINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) $(AM_LDFLAGS) $(LDFLAGS) \
	-o $@
SOURCES = $(casegen_SOURCES) $(test_bitmap_SOURCES) \
	$(test_graph_SOURCES)
DIST_SOURCES = $(casegen_SOURCES) $(test_bitmap_SOURCES) \
	$(test_graph_SOURCES)
ETAGS = etags
CTAGS = ctags
am__tty_colors = \
...
OBJEXT = o
PACKAGE = ssvctest
PACKAGE_BUGREPORT = ssvc.test@webex.com
PACKAGE_NAME = Cast Generator Tool
PACKAGE_STRING = Cast Generator Tool 1.0.0
PACKAGE_TARNAME = ssvctest
...
STRIP = 
VERSION = 1.0.0
abs_builddir = /home/josh/workspace/cpp/casegen
abs_srcdir = /home/josh/workspace/cpp/casegen
abs_top_builddir = /home/josh/workspace/cpp/casegen
abs_top_srcdir = /home/josh/workspace/cpp/casegen
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/josh/workspace/cpp/casegen/build-aux/install-sh
...
casegen$(EXEEXT): $(casegen_OBJECTS) $(casegen_DEPENDENCIES) 
	@rm -f casegen$(EXEEXT)
	$(CXXLINK) $(casegen_OBJECTS) $(casegen_LDADD) $(LIBS)
test_bitmap$(EXEEXT): $(test_bitmap_OBJECTS) $(test_bitmap_DEPENDENCIES) 
	@rm -f test_bitmap$(EXEEXT)
	$(CXXLINK) $(test_bitmap_OBJECTS) $(test_bitmap_LDADD) $(LIBS)
test_graph$(EXEEXT): $(test_graph_OBJECTS) $(test_graph_DEPENDENCIES) 
	@rm -f test_graph$(EXEEXT)
	$(CXXLINK) $(test_graph_OBJECTS) $(test_graph_LDADD) $(LIBS)
...
include ./$(DEPDIR)/casegen.Po
include ./$(DEPDIR)/graph.Po
include ./$(DEPDIR)/state_machine.Po
include ./$(DEPDIR)/test_bitmap.Po
include ./$(DEPDIR)/test_graph.Po
include ./$(DEPDIR)/traveller.Po
